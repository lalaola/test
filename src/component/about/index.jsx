    ...
    return (
        <motion.div
            ...
            <div className="img-bg">
                ...
                <Img />
                <div className="col-10 row d-flex isi-about mx-auto">
                    <div className="text col-7">
                        ...
                        <div className="cv pt-4"><button className='btn btn-dark'>Download Cv</button></div>
                    </div>
                    <div className="foto col-5 d-flex align-items-end">
